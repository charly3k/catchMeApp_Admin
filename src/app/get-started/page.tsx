      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <Card className="mb-12 border-[#ff0a54]/20 shadow-lg hover:shadow-xl transition-shadow duration-300">
          ...
          <CardContent className="pt-6">
            <p className="text-lg leading-relaxed text-black">
              ...
              unforgettable vibes. Signing up is quick and easy. Just follow the
              steps below and you&apos;ll be in the loop in no time.
            </p>
          </CardContent>
        </Card>
            ...
            <Card className="border-[#ff0a54]/20 shadow-lg hover:shadow-xl transition-all duration-300 hover:border-[#ff0a54]/40">
              ...
              <CardContent className="pt-6">
                <ul className="space-y-2 text-black mb-6">
                  <li className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-[#ff0a54] rounded-full"></div>
                    Enter your student email address (recommended for access to
              ...
              <CardContent className="pt-6">
                ...
                <ul className="space-y-2 text-black ml-4 mb-6">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Add Profile photo (you must upload at least 2 photos, and
                      your first photo must be a picture of you to prevent your
                      account from being deactivated. Also, any obscene photo
                      will lead to deactivation and/or deletion of your account
                ...
                <ul className="space-y-2 text-black">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      your visibility and chance of finding your date, friend or
                      study partner.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
        ...
        <div className="mb-12">
          ...
          <div className="space-y-6">
            ...
            <div className="p-6 bg-gradient-to-r from-[#ff0a54]/5 to-transparent rounded-lg border border-[#ff0a54]/10">
              <h3 className="text-lg font-semibold mb-2 text-[#ff0a54]">
                Q: I didn&apos;t receive a verification code. What should I do?
              </h3>
              <p className="text-black">
        ...
        <div className="text-center bg-gradient-to-r from-[#ff0a54]/5 via-transparent to-[#ff0a54]/5 p-12 rounded-2xl border border-[#ff0a54]/10">
          <h2 className="text-3xl font-bold mb-6 text-black">Call-to-Action</h2>
