  ...
  return (
    <div className="md:px-40 px-10  py-20 flex flex-col gap-10  items-center   justify-flex-end">
      <h4 className="font-raleway text-3xl text-black ">
        Life as a student could be stressful but dating as a student should not
        be stressful
      </h4>
      <p className="font-dmSans text-black">
        ...
        without worrying about complicated dating dynamics. CatchMeApp takes the
        stress out of student dating so you can enjoy meeting new people while
